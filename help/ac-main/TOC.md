...
+ Gerenciamento e automatização de processos{#process-management}
   ...
   + [criar um resumo de conteúdo](help/tutorial-using-soap-apis/create-a-content-digest-overview.md)
+ Gerenciamento de dados {#data-management}
   ...
   + [Tutorial: Uso de APIs SOAP](https://experienceleague.adobe.com/docs/campaign-learn/using-soap-apis/introduction.html?lang=en)
